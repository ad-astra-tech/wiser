...
def test_query_job_config_builder_no_write_disposition_raises_value_error():
    """
...
def test_query_job_config_builder_no_destination_raises_value_error():
    """
    GIVEN BigQueryQueryJobConfigBuilder
    WHEN  the write disposition is not set
    THEN a value error is raised
...
def test_query_job_config_builder_returns_query_job_config():
    """
    GIVEN BigQueryQueryJobConfigBuilder
    ...
    assert job_config.destination == table_reference
    assert (
