...
class StorageConnector:
    ...
    def upload_from_string(self, data: bytes, bucket_name: str, destination_blob_name: str):
        self._client. \
            bucket(bucket_name=bucket_name). \
            blob(blob_name=destination_blob_name).\
    ...
    def copy(self, source_bucket_name: str, source_blob_name: str, dest_bucket_name: str, dest_blob_name: str):
